...
const img = "/"+props.name.toString().replace('\s+', '_').toLowerCase()+".png";
</script>
...
<div class="w-20 shadow-lg rounded-lg">
    <div v-if="isDark" id="dark" class="rounded-lg flex flex-col">
    ...
    <div v-else id="light" class="rounded-lg flex flex-col">
    <span class="relative left-14 -top-1">
    <a :href="gh" target="_blank"
    class="icon-btn !border-none">
    <carbon-logo-github/>
